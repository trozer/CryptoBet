...
public class TimePickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    private CryptoDetailsActivity cryptoDetailsActivity;

    public TimePickerFragment() {
        // Required empty public constructor
    }

    public void setArgs(CryptoDetailsActivity cryptoDetailsActivity){
        this.cryptoDetailsActivity = cryptoDetailsActivity;
    }
